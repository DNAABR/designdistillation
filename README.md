...
- deterministic recipe selection from explicit product type or free-text requirements;
- bounded personality resolution with visible clamp diagnostics;
- platform normalization, accessibility targeting, theme selection, and reduced-motion support;
- generated `design-profile.json`, `DESIGN.md`, and `AGENTS.design.md` artifacts;
- non-negotiable brand-safety rules;
- validation and regression tests across the corpus, tokens, recipes, blending, and composer.
